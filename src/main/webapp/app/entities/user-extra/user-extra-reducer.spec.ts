...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEREXTRA_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEREXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEREXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEREXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEREXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEREXTRA actions', async () => {
      const expectedActions = [
        {
