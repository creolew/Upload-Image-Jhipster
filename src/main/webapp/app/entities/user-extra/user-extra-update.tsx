  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="uploadImageApp.userExtra.home.createOrEditLabel" data-cy="UserExtraCreateUpdateHeading">
            <Translate contentKey="uploadImageApp.userExtra.home.createOrEditLabel">Create or edit a UserExtra</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('uploadImageApp.userExtra.frontImage')}
                id="user-extra-frontImage"
                name="frontImage"
                data-cy="frontImage"
                type="text"
              />
              <ValidatedField
                label={translate('uploadImageApp.userExtra.backImage')}
                id="user-extra-backImage"
                name="backImage"
                data-cy="backImage"
                type="text"
              />
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('uploadImageApp.userExtra.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
