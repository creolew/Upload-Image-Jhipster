...
public class UserService {
    ...
    public User registerUser(AdminUserDTO userDTO, String password, String frontImage, String backImage) {
        userRepository
     ...
     // Create and save the UserExtra entity
        ...
        newUserExtra.setFrontImage(frontImage);
        newUserExtra.setBackImage(backImage);
...
//-----------------------------
    ...
    public void updateUserWithImage(String imageUrl) {
        SecurityUtils
            .getCurrentUserLogin()
            .flatMap(userRepository::findOneByLogin)
            .ifPresent(user -> {
